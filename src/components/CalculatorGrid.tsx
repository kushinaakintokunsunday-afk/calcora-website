...
const CALCULATORS: CalculatorCard[] = [
  ...
  },
  {
    ...
    description: "Compute equated monthly installments for any loan with a detailed amortization breakdown.",
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description: "See how your money grows over time with compound interest. View year-by-year breakdowns.",
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description: "Find out what your money will be worth in the future or what past amounts equal today.",
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description: "Find your daily calorie needs based on the Mifflin-St Jeor equation. Get targets for weight loss or gain.",
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description: "Compare avalanche vs snowball strategies. See how fast you can become debt-free.",
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
